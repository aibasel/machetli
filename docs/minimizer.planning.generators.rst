...
Example showcasing the :class:`RemoveActions <minimizer.planning.generators.RemoveActions>` successor generator:

    >>> from minimizer.planning.generators import RemoveActions
    >>> from minimizer.planning.auxiliary import parse_pddl_task
    >>> state = {
...
.. automodule:: minimizer.planning.generators
